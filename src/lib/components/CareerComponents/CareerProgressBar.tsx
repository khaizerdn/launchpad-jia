...
export default function CareerProgressBar({ isStep1Complete = false }: CareerProgressBarProps) {
    return (
        <div className={styles.progressBar}>
            <div className={styles.stepProgress}>
                ...
                <div className={styles.textGroup}>
                    <span className={styles.stepTitle}>Career Details & Team Access</span>
                </div>
            </div>
            <div className={styles.stepProgress}>
                <div className={styles.stepContainer}>
                ...
                <div className={styles.textGroup}>
                    <span className={`${styles.stepTitle} ${styles.inactive}`}>CV Review & Pre-screening</span>
                </div>
            </div>
            <div className={styles.stepProgress}>
                <div className={styles.stepContainer}>
                ...
                <div className={styles.textGroup}>
                    <span className={`${styles.stepTitle} ${styles.inactive}`}>AI Interview Setup</span>
                </div>
            </div>
            <div className={styles.stepProgress}>
                <div className={styles.stepContainer}>
                ...
                <div className={styles.textGroup}>
                    <span className={`${styles.stepTitle} ${styles.inactive}`}>Pipeline Stages</span>
                </div>
            </div>
            <div className={`${styles.stepProgress} ${styles.stepProgressLast}`}>
                ...
                <div className={`${styles.textGroup} ${styles.textGroupLast}`}>
                    <span className={`${styles.stepTitle} ${styles.stepTitleLast} ${styles.inactive}`}>Review Career</span>
                </div>
            </div>
        </div>
    );
